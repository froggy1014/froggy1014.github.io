  ...
  return (
    <section className="flex flex-col items-center p-4 md:p-6 lg:p-8 text-center">
      ...
      <div className="flex gap-2 md:gap-3 lg:gap-4 mb-2">
        <IconLink
          icon={
            <GitHubLogoIcon className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12" />
          }
        ...
        <IconLink
          icon={
            <InstagramLogoIcon className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12" />
          }
        ...
        <IconLink
          icon={
            <LinkedInLogoIcon className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12" />
          }
